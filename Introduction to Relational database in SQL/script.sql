...
--Description : Introduction to Relational database in SQL
--Author : Sofiane Boumelit
--Date : August 20, 2024

--Chapter I : Your first database
/*
...
… are called "relational" because they store data only about people.(X)
...
--Chapter II : Enforce data consistency with attribute constraints
/*
